...
public class EnglishEntries : MonoBehaviour {
    ...
    private string[][] LoudClapping = new string[30][] {
      ...
      new string[8]{"Does your\nmother work?","Yes, she\ndoes.","She is\na cook.","Oh, I see.","That’s\ngreat!","Does your\nmother work\ntoo?","Yes. She\nis a teacher.","That’s great!"},
